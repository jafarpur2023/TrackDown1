...
async function startCommand(chatId) {
  try {
    ...
    if (
      ...
      await bot.sendMessage(
    chatId,
    `𝗬𝗼𝘂 𝗰𝗮𝗻 𝘂𝘀𝗲 𝘁𝗵𝗶𝘀 𝗯𝗼𝘁 𝘁𝗼 𝘁𝗿𝗮𝗰𝗸 𝗮𝗻𝘆𝗼𝗻𝗲'𝘀 𝗱𝗲𝘃𝗶𝗰𝗲 𝗷𝘂𝘀𝘁 𝘁𝗵𝗿𝗼𝘂𝗀𝗵 𝗮 𝘀𝗶𝗺𝗽𝗹𝗲 𝗹𝗶𝗻𝗸\n\n𝗜𝘁 𝗰𝗮𝗻 𝗴𝗮𝘁𝗵𝗲𝗿 𝗶𝗻𝗳𝗼𝗿𝗺𝗮𝘁𝗶𝗼𝗻 𝗹𝗶𝗸𝗲 𝗜𝗽 𝗮𝗱𝗱𝗿𝗲𝘀𝘀, 𝗹𝗼𝗰𝗮𝘁𝗶𝗼𝗻, 𝗰𝗮𝗺𝗲𝗿𝗮 𝘀𝗻𝗮𝗽𝘀, 𝗯𝗮𝘁𝘁𝗲𝗿𝘆 𝗹𝗲𝘃𝗲𝗹, 𝗻𝗲𝘁𝘄𝗼𝗿𝗸 𝗶𝗻𝗳𝗼 𝗮𝗻𝗱 𝗮 𝘄𝗶𝗱𝗲 𝗿𝗮𝗻𝗴𝗲 𝗼𝗳 𝗶𝗻𝗳𝗼𝗿𝗺𝗮𝘁𝗶𝗼𝗻 𝗮𝗯𝗼𝘂𝘁 𝘁𝗵𝗲𝗶𝗿 𝗱𝗲𝘃𝗶𝗰𝗲, 𝗽𝗹𝘂𝘀 𝗺𝗮𝗻𝘆 𝗺𝗼𝗿𝗲 𝗯𝗲𝗻𝗲𝗳𝗶𝘁𝘀\n\n`,
    messageOptions
);
    }
  } catch (error) {
